...
public class FooterStepDefinitions {
    ...
    public void user_enters_a_valid_email_into_the_newsletter_field() {
        ...
        ReusableMethods.wait(2); // bir nefes alalım :)
    }
    ...
    public void user_clicks_the_subscribe_button() {
        footerPage.subscribeButton.click(); // sendKeys değil
    ...
    public void each_should_redirect_to_the_correct_social_media_page() {
    ...
    public void user_should_see_the_copyright_text_with_the_current_year() {
        String currentYear = String.valueOf(java.time.Year.now());
        Assert.assertTrue(footerPage.copyrightText.getText().contains(currentYear));
    ...
    public void user_clicks_the_back_to_top_button() {
        JSUtilities.clickWithJS(driver, footerPage.backToTopButton);
